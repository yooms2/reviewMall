		...
		$(function() {
			$('input[name="mid"]').keyup(function() {
				...
				if(mid.length < 4) {
					...
					$('#midConfirm').html('<b>영문/숫자로만 입력해주세요</b>');
				} else {
					$.ajax({
			...
			$('input[name="memail"]').keyup(function() {
				...
				if(!memail) {
					...
					$('#memailConfirm').html('<b>메일형식에 맞게 입력해주세요</b>');
				} else {
					$.ajax({
		...
		<form action="${conPath }/join.do" method="post">
			<table>
				...
				<tr>
					<th>닉네임 <b>*</b></th>
					<td>
						<input type="text" name="mnickname" required="required">
				...
				<tr>
					<th>성별</th>
					<td>
						남자<input type="radio" name="gender" id="m" class="gender">
						여자<input type="radio" name="gender" id="f" class="gender">
					</td>
				</tr>
				<tr>
					<th>주소</th>
